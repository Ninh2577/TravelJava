...
public class AuthController {
    ...
    public ResponseEntity<Map<String, Object>> login(@RequestBody NguoiDung loginRequest,
        ...
        try {
            ...
            responseBody.put("namSinh", nguoiDung.getNamSinh());
            responseBody.put("soDienThoai", nguoiDung.getSoDienThoai());
    ...
    public ResponseEntity<Map<String, Object>> getUserGG(@AuthenticationPrincipal OAuth2User googleUser) {
        ...
        userResponse.put("namSinh", nguoiDung.getNamSinh());
        userResponse.put("soDienThoai", nguoiDung.getSoDienThoai());
    ...
    public ResponseEntity<Map<String, Object>> getUserFB(@AuthenticationPrincipal OAuth2User facebookUser) {
        ...
        // String birthday = (String) facebookUser.getAttributes().get("birthday"); //
        // Dự kiến định dạng yyyy-MM-dd
        // String gender = (String) facebookUser.getAttributes().get("gender"); // male
        // hoặc female
        ...
        // boolean isMale = "male".equalsIgnoreCase(gender); // Giới tính male => true,
        // female => false
        ...
        userResponse.put("diaChi", nguoiDung.getDiaChi());
        userResponse.put("vaiTro", nguoiDung.getVaiTro().getVaiTro());
        // userResponse.put("birthday", nguoiDung.getNamSinh()); // Trả về ngày sinh
        // dưới dạng Date
        // userResponse.put("gender", nguoiDung.isGioiTinh() ? "male" : "female"); //
        // Trả về giới tính
