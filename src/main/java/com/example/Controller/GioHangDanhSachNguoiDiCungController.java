...
public class GioHangDanhSachNguoiDiCungController {
	...
	@PostMapping("/them")
	public ResponseEntity<GioHangDanhSachNguoiDiCung> addGioHangDanhSachNguoiDiCung (@RequestBody GioHangDanhSachNguoiDiCung gioHangDanhSachNguoiDiCung){
		GioHangDanhSachNguoiDiCung savedGioHangDanhSachNguoiDiCung = gioHangDanhSachNguoiDiCungService.addGioHangDanhSachNguoiDiCung(gioHangDanhSachNguoiDiCung);
